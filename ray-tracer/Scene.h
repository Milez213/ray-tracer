...
{
public:
   static Scene *CreateScene(const vector<Traceable *> *objects,
   ...
   const vector<Traceable *> *Objects() { return objects; };
   
private:
   Scene(const vector<Traceable *> *objects,
         const vector<AbstractLight *> *lights,
         const Camera *camera);
   ...
   const vector<AbstractLight *> *lights;
   const vector<Traceable *> *objects;
   const Camera *camera;
